...
import styles from './Header.module.scss'; // импорт стилей модуля
		...
		>
			<div className={styles.header__container}>
				<div className={styles.header__left + ' ' + styles['header-left']}>
					<Link
						href="/"
						className={styles['header-left__logo'] + ' -ibg_contain'}
					>
						<StrapiImage
							src={logo.url}
				...
				<div className={styles.header__right + ' ' + styles['header-right']}>
					...
					>
						...
						<span className={styles['header-right__info-item-link']}>
							{number}
						</span>
					</a>
					...
					<Link
						href="/profile"
						className={styles['header-right__profile-btn'] + ' -ibg_contain'}
					>
						<ProfileIcon />
					</Link>
